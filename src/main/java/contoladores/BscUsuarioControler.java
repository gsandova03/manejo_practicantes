 ...
 * @author jfilot
 */
@WebServlet(name = "BscUsuarioControler", urlPatterns = {"/BscUsuarioControler"})
public class BscUsuarioControler extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (this.exiteUsuari != null) {
            ...
            request.getRequestDispatcher("vista/registroUsuario/registroUsuario.jsp").forward(request, response);
        } else {
            bcsUsuario.create(usuario);
