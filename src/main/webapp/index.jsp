...
<html>
    ...
    <body>
        ...
        <br/>
        <a href="${pageContext.request.contextPath}/vistas/contenido/insert.jsp">Tabla de Contenido</a>
        <br/>
        <a href="${pageContext.request.contextPath}/controladorCont?accion=read">Lista cotenido</a>
        <br/>
    </body>
</html>
